...
<div class="card card-soft shadow-sm mb-4">
    <div class="d-flex flex-wrap justify-content-between align-items-center gap-3">
        <div>
            <h2 class="section-title h3 mb-1">Available trips</h2>
            <p class="text-muted mb-0">Search and book your next trip.</p>
        </div>
        <a href="<?= base_url('reservations/create') ?>" class="btn btn-primary">Create reservation</a>
    </div>
